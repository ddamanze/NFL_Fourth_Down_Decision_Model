...
def load_pipeline_outputs():
    ...
    return outputs["df"], outputs["df_model"], outputs["base_pred_df"]#, outputs["df_punt_fg"]

df, df_model, base_pred_df = load_pipeline_outputs()
...
with tab4:
        ...
        if st.button("See Summary"):
            ...
            with st.spinner("Creating recap with OpenAI..."):
                response = client.chat.completions.create(
                    ...
                    "3. Convert half_seconds_remaining to standard clock format (e.g., 1730 → 14:30) using qtr to determine the quarter. Never include anything over 14:59.\n"
    ...
    if scout_mode == "Coaches":
        ...
        # Taking out anything longer than 4th and 10
        coach_recap_df = coach_recap_df[(coach_recap_df['posteam_coach'] == selected_coach) & (coach_recap_df['ydstogo'] < 10)]
